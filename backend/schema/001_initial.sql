...
CREATE TABLE display_land_mask (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX display_land_mask_geom_idx ON display_land_mask USING gist (geom);

CREATE TABLE electorate_boundary_display_geometry (
    id BIGSERIAL PRIMARY KEY,
...
CREATE INDEX electorate_boundary_display_geometry_geom_idx
...
CREATE TABLE party_entity_link (
    id BIGSERIAL PRIMARY KEY,
